...
- [x] There is an agreed production bundle budget, checked in CI. 120 KB gzip on the
      ...
      push. Currently 115.9 KB. Konnekt's equivalent is 165 KB. It was 550 KB
...
- The title bar, settings dialog, icon set, pinned-generator store and its tile cost
  ...
  behind `revision` added 0.5 KB more, leaving 115.9 KB against the 120 KB ceiling.
  That is still a pass, and
