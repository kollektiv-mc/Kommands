 ...
 *
 * Derived, never stored on the definition: caching it in `src/data/generated/**` would
 * put it in a file the clean-diff health check owns, and the walk is cheap enough that
 * there is nothing to buy by doing so.
 */
