...
import { buildTree, describeTree, type CsgNode, type CsgTree, type NodeId } from './tree'
 ...
 */
function samplePoints(random: () => number): Array<[number, number, number]> {
...
function randomTree(random: () => number, depth = 3): CsgTree {
